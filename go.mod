module github.com/baoyxing/geo-rpc
...
require (
	...
	github.com/baoyxing/micro-extend v0.0.0-20231115095844-ea3234c6e9d7
...
require (
	...
	github.com/polarismesh/polaris-go v1.5.6 // indirect
